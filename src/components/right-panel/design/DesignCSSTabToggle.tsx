...
export function DesignCSSTabToggle({ activeTab, onTabChange }: DesignCSSTabToggleProps) {
  return (
    <div
    ...
    >
      <div className="flex items-center gap-0.5 rounded p-0.5" style={{ background: 'var(--bg-tertiary)' }}>
        <button
          ...
          style={{
            background: activeTab === 'design' ? 'var(--accent-bg, rgba(74,158,255,0.15))' : 'transparent',
            color: activeTab === 'design' ? 'var(--accent)' : 'var(--text-muted)',
          }}
        >
          Design
        </button>
        <button
          ...
          className="px-3 py-0.5 text-[11px] rounded transition-colors"
          style={{
            background: activeTab === 'css' ? 'var(--accent-bg, rgba(74,158,255,0.15))' : 'transparent',
