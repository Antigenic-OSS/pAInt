      ...
      <div className="mx-auto px-6 py-12" style={{ maxWidth: '1024px' }}>
        ...
        <Section id="how-it-works" title="How It Works">
          ...
          <p style={{ ...bodyText, marginTop: '0.75rem' }}>
            When you click <strong style={{ color: 'var(--text-primary)' }}>Connect</strong>,
            the editor loads your page through a{' '}
            <strong style={{ color: 'var(--text-primary)' }}>built-in reverse proxy</strong>.
            The proxy fetches your HTML, strips client-side scripts (to prevent
            routing conflicts), and injects a lightweight inspector script. This
            inspector communicates with the editor via{' '}
            <code style={inlineCodeStyle}>postMessage</code> — reporting element
            metadata when you hover or click, and applying style previews in
            real time.
          </p>
          <p style={{ ...bodyText, marginTop: '0.75rem' }}>
            Every change you make is tracked as a changelog entry with original
            and new values. When you&apos;re done, export the changelog and paste
            it into Claude Code (or use the built-in Send to Claude Code feature)
            to have the changes applied to your actual source files.
          </p>
          <p style={{ ...bodyText, marginTop: '0.75rem' }}>
            If automatic injection fails (e.g., non-standard HTML responses), a
            banner will prompt you to add the script tag manually. The framework
            guides below show exactly where to place it.
          </p>
        </Section>
          ...
          <ol className="list-none p-0 m-0 flex flex-col gap-5">
            <Step number={1}>
              ...
              <p style={{ ...mutedText, marginTop: '0.25rem' }}>
                Running locally? Start with <code style={inlineCodeStyle}>bun dev</code>{' '}
                (defaults to <code style={inlineCodeStyle}>http://localhost:4000</code>).
              </p>
            </Step>
            <Step number={2}>
              <strong style={{ color: 'var(--text-primary)', fontSize: '1rem' }}>Start your target project</strong>
              <p style={{ ...bodyText, marginTop: '0.25rem' }}>
                Run your project&apos;s dev server as usual (e.g.,{' '}
                <code style={inlineCodeStyle}>npm run dev</code> on port 3000).
              </p>
            </Step>
            <Step number={3}>
        ...
        <Section id="framework-guides" title="Framework Guides">
          <p style={{ ...bodyText, marginBottom: '1rem' }}>
            If the automatic connection doesn&apos;t detect the inspector within
            5 seconds, add the script tag manually to your project. Select your
            framework below for the exact file and placement.
          </p>
          <div
          ...
          >
            ...
            <span>
              ...
              with{' '}
              <code style={{ ...inlineCodeStyle, fontSize: '0.8em' }}>http://localhost:4000</code>{' '}
              (or your custom port).
            </span>
          </div>
          <FrameworkAccordion>
      ...
      <body>
        ...
        <script src="https://dev-editor-flow.vercel.app/dev-editor-inspector.js"></script>
              ...
              <div>
                ...
                <p style={{ ...mutedText, marginBottom: '0.5rem' }}>
                  Add to <code style={inlineCodeStyle}>pages/_document.tsx</code>
                </p>
                <CodeBlock
                  language="tsx"
                  copyText={SCRIPT_TAG}
    ...
    <Html>
      ...
      <body>
        ...
        <script src="https://dev-editor-flow.vercel.app/dev-editor-inspector.js"></script>
            ...
            {/* Vite + React */}
            <FrameworkSection id="vite-react" title="Vite + React" icon="&#9889;">
              <p style={{ ...mutedText, marginBottom: '0.5rem' }}>
                Add to <code style={inlineCodeStyle}>index.html</code> (project root)
              </p>
              <CodeBlock
                language="html"
                copyText={SCRIPT_TAG}
...
<html lang="en">
  ...
  <body>
    ...
    <script src="https://dev-editor-flow.vercel.app/dev-editor-inspector.js"></script>
            ...
            {/* Create React App */}
            <FrameworkSection id="create-react-app" title="Create React App" icon="&#9883;">
              <p style={{ ...mutedText, marginBottom: '0.5rem' }}>
                Add to <code style={inlineCodeStyle}>public/index.html</code>
              </p>
              <CodeBlock
                language="html"
                copyText={SCRIPT_TAG}
...
<html lang="en">
  ...
  <body>
    ...
    <script src="https://dev-editor-flow.vercel.app/dev-editor-inspector.js"></script>
            ...
            {/* Plain HTML */}
            <FrameworkSection id="plain-html" title="Plain HTML" icon="&#128196;">
              <p style={{ ...mutedText, marginBottom: '0.5rem' }}>
                Add before <code style={inlineCodeStyle}>&lt;/body&gt;</code> in any{' '}
...
<html>
  ...
  <body>
    ...
    <script src="https://dev-editor-flow.vercel.app/dev-editor-inspector.js"></script>
            ...
            <FrameworkSection id="react-native-expo" title="React Native / Expo Web" icon="&#128241;">
              <div>
                <h4 className="text-base font-medium mb-1" style={{ color: 'var(--text-primary)' }}>
                  Expo Router
                </h4>
                <p style={{ ...mutedText, marginBottom: '0.5rem' }}>
                  Add to <code style={inlineCodeStyle}>app/_layout.tsx</code> using{' '}
                  a <code style={inlineCodeStyle}>&lt;Script&gt;</code> component or
                  the web <code style={inlineCodeStyle}>index.html</code>
                </p>
                <CodeBlock
                  language="tsx"
                  copyText={SCRIPT_TAG}
...
<html>
  ...
  <body>
    ...
    <script src="https://dev-editor-flow.vercel.app/dev-editor-inspector.js"></script>
            ...
            {/* Vue / Nuxt */}
            <FrameworkSection id="vue-nuxt" title="Vue / Nuxt" icon="&#9899;">
              <div>
                <h4 className="text-base font-medium mb-1" style={{ color: 'var(--text-primary)' }}>
                  Vue (Vite)
                </h4>
  ...
  <body>
    ...
    <script src="https://dev-editor-flow.vercel.app/dev-editor-inspector.js"></script>
              ...
              <div>
                ...
                <p style={{ ...mutedText, marginBottom: '0.5rem' }}>
                  Add via <code style={inlineCodeStyle}>nuxt.config.ts</code> or{' '}
    ...
    head: {
      script: [
        { src: 'https://dev-editor-flow.vercel.app/dev-editor-inspector.js' }
            ...
            {/* Svelte / SvelteKit */}
            <FrameworkSection id="svelte-sveltekit" title="Svelte / SvelteKit" icon="&#127793;">
              <p style={{ ...mutedText, marginBottom: '0.5rem' }}>
  ...
  <body data-sveltekit-preload-data="hover">
    ...
    <script src="https://dev-editor-flow.vercel.app/dev-editor-inspector.js"></script>
        ...
        <Section id="troubleshooting" title="Troubleshooting">
          <div className="flex flex-col gap-4">
            ...
            <TroubleshootItem title="COEP / COOP headers blocking the iframe">
              <p>
                Some frameworks set{' '}
                <code style={inlineCodeStyle}>Cross-Origin-Embedder-Policy</code>{' '}
                or{' '}
                <code style={inlineCodeStyle}>Cross-Origin-Opener-Policy</code>{' '}
            ...
            <TroubleshootItem title="Styles look different in the editor">
              <p>
                The proxy serves SSR HTML with CSS intact but strips JavaScript.
                If your styles depend on client-side JS (e.g., CSS-in-JS runtime
                injection), some styles may be missing. Use the manual script
                method with your full dev server if CSS-in-JS is critical.
              </p>
            </TroubleshootItem>
          </div>
        </Section>
        ...
        <Section id="faq" title="FAQ">
          <FaqAccordion>
            <FaqSection id="faq-safe" question="Is it safe to add the inspector script to my project?">
              <p>
            ...
            <FaqSection id="faq-source" question="Does pAInt have access to my source files?">
              <p>
                ...
                on its own. When you use the <strong style={{ color: 'var(--text-primary)' }}>
                Send to Claude Code</strong> feature, a changelog of your visual
                edits is sent to Claude Code (running locally on your machine),
                which then applies changes to your files. The editor itself has
                no filesystem access.
              </p>
            </FaqSection>

            <FaqSection id="faq-proxy" question="Does the reverse proxy forward requests to external servers?">
              <p>
                No. The proxy enforces <strong style={{ color: 'var(--text-primary)' }}>
                localhost-only</strong> validation. It will only connect to{' '}
                <code style={inlineCodeStyle}>127.0.0.1</code> /{' '}
                <code style={inlineCodeStyle}>localhost</code> addresses. Any
                attempt to proxy to an external host is rejected.
              </p>
            </FaqSection>

            <FaqSection id="faq-production" question="Should I remove the script tag before deploying to production?">
              <p>
            ...
            <FaqSection id="faq-hosted" question="Is my data sent anywhere when using the hosted version?">
              <p>
                The hosted version at{' '}
                <code style={inlineCodeStyle}>dev-editor-flow.vercel.app</code>{' '}
                serves the editor UI only. Your project&apos;s HTML is fetched by
                the proxy running on that server, but no project data is stored,
                logged, or shared. All style edits and changelogs are kept in your
                browser&apos;s <code style={inlineCodeStyle}>localStorage</code>.
              </p>
            </FaqSection>
          </FaqAccordion>
        </Section>
